...
Este documento describe tu empresa y la situación concreta para la que estás construyendo este hito. Léelo completo antes de escribir ningún código. Todo lo que construyes debe reflejar este contexto.
...
Llamado a la acción: Botón "Únete a nuestro banco de talento" que enlace al formulario
...
Programas de habilidades blandas y liderazgo
...
Contacto
Correo electrónico: contacto@nexova.com
...
Nombre completo	texto	Mínimo 2 palabras	Si
Correo electrónico	correo electrónico	Formato válido de email	Si
Teléfono	tel	Formato: +[código país] [número] (ej: +34 612 345 678)	Si
País de residencia	seleccionar	España / Estados Unidos / Otro	Si
Años de experiencia	número	Entre 0 y 50	Si
Sector de interés	seleccionar	Tecnología / Retail / Servicios Financieros / Consultoría / Otro	Si
Nivel de inglés	seleccionar	Básico / Intermedio / Avanzado / Nativo	Si
Disponibilidad	radio	Inmediata / 1 mes / 2-3 meses / Solo explorando	Si
LinkedIn (URL del perfil)	URL	Formato URL válido	No
Comentarios adicionales	área de texto	Máximo 500 caracteres	No
Acepto política de datos	caja	Debe estar marcado para enviar	Si
Validaciones específicas
Email: Debe validar que contiene @ y un dominio válido (ej: usuario@dominio.com )
...
LinkedIn: "Si incluye LinkedIn, debe ser una URL válida"
Comentarios: "Los comentarios no pueden exceder los 500 caracteres (quedan X)"
Política de datos: "Debes aceptar la política de tratamiento de datos para continuar"
Mensaje de éxito
Cuando el formulario se valide correctamente (envío simular), muestre:
...
Se requiere marcado Schema.org
Implementa el siguiente marcado Schema.org en tu página de inicio:
